...
export class WeatherComponent {
    ...
    columnDefs = [
        ...
        {headerName: 'City', field: 'name', sortable: true, filter: true },
        {headerName: 'Temperature', field: 'email', sortable: true, filter: true },
        {headerName: 'Humidity', field: 'email', sortable: true, filter: true },
        {headerName: 'Description', field: 'email', sortable: true, filter: true }
    ];
    /*
